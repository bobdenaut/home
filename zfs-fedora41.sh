...
zfs set recordsize=1M zroot/var/lib/containers
###after user creation#####################################
# create aditional datasets
#zfs create -o mountpoint=/home/liviu/.cache zroot/home/liviu_cache
#zfs create -o mountpoint=/home/liviu/.mozilla zroot/home/liviu_mozilla
#zfs create -o mountpoint=/home/liviu/.librewolf zroot/home/liviu_librewolf
#####################################################
...
dnf4 --installroot=/mnt --releasever=$VERSION_ID group install -y core
dnf4 --installroot=/mnt install -y glibc-langpack-en
